...
ac = pd.read_csv("../data/model1_3/customer_oneday_10_25_50p.csv")
...
def getModel(data):
    ...
    # Supply does not exceed demand/ equals to demand if it's prioritized
    for node in data['AC']:
        ind = []
        co = []
        for v in range(data['H']):
        ...
        rhsConstr.append(data['AC'][node][2])
